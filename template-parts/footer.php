        	...
        	<nav class="footer-navigation__main">
        		<ul class="footer-navigation__list">
        			<li class="footer-navigation__list-item">
        				<a href="#about" class="footer-navigation__link anchor">Experience</a>
        			</li>
        			<li class="footer-navigation__list-item">
        				<a href="#culture" class="footer-navigation__link anchor">Company</a>
        			</li>
        			<li class="footer-navigation__list-item">
        				<a href="#openings" class="footer-navigation__link anchor">Careers</a>
        			</li>
        			<li class="footer-navigation__list-item">
